...
* Integrations & Plugins (third-party libraries):
  * [Esri-gl](https://github.com/muimsd/esri-gl) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
* Arcade:
  * [ArcGIS Arcade Expression Templates](https://github.com/Esri/arcade-expressions) ⭐ 363 | 🐛 17 | 🌐 JavaScript | 📅 2026-04-08 - Collection of reusable Arcade expressions across all supported profiles.
* iOS:
...
* JavaScript:
  * [Esri/jsapi-resources](https://github.com/Esri/jsapi-resources) ⭐ 771 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-08 - A collection of resources for developers using the ArcGIS API for JavaScript.
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 390 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-27 - Demo apps built by Esri's REST JS maintainers.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 6,033 | 🐛 576 | 🌐 C++ | 📅 2026-08-27 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,168 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-21 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,168 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-21 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,234 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-17 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,460 | 🐛 283 | 🌐 TypeScript | 📅 2026-08-18 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,675 | 🐛 159 | 📅 2026-08-27 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,502 | 🐛 62 | 📅 2026-07-21 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,270 | 🐛 2 | 📅 2026-08-25 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,622 | 🐛 3 | 📅 2026-08-10 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,531 | 🐛 1 | 📅 2026-07-23 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
...
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,824 | 🐛 11 | 📅 2026-05-26 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
...
You can [file an issue](https://github.com/ArcGIS/awesome-arcgis-developer/issues/new) ⭐ 331 | 🐛 9 | 📅 2026-04-14 to request or suggest a specific resource.

<!--lint disable no-emphasis-as-heading-->

**Contributing**

Esri welcomes contributions from anyone and everyone. You can [issue a pull request](https://github.com/ArcGIS/awesome-arcgis-developer/pulls) ⭐ 331 | 🐛 9 | 📅 2026-04-14 to propose an update, but before doing it, please:

* Take a look at [previously logged issues](https://github.com/ArcGIS/awesome-arcgis-developer/issues) ⭐ 331 | 🐛 9 | 📅 2026-04-14.
