...
* [EsriJapan/arcgis-dev-resources](https://github.com/EsriJapan/arcgis-dev-resources) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2026-08-24 - ArcGIS Developers 開発リソース集 (by Esri Japan).
...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 389 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-24 - Demo apps built by Esri's REST JS maintainers.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 6,030 | 🐛 574 | 🌐 C++ | 📅 2026-08-22 - Translator library for raster and vector geospatial data formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,167 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-21 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,232 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-17 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,458 | 🐛 283 | 🌐 TypeScript | 📅 2026-08-18 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,611 | 🐛 159 | 📅 2026-08-24 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,499 | 🐛 61 | 📅 2026-07-21 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,270 | 🐛 2 | 📅 2026-08-20 - Databases, radar, lidar, web map development, etc.
