...
* SDKs for Extending ArcGIS Products:
  * [ArcGIS CityEngine SDKs (C++)](https://github.com/esri/cityengine-sdk) ⭐ 224 | 🐛 0 | 📅 2026-07-01 - C++ APIs, documentation, and examples for the Procedural Runtime (PRT).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 6,050 | 🐛 565 | 🌐 C++ | 📅 2026-09-09 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,173 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-07 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,173 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-07 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,242 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-17 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,475 | 🐛 285 | 🌐 TypeScript | 📅 2026-09-07 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,879 | 🐛 158 | 📅 2026-09-08 - A topic-centric list of high-quality open datasets.
...
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,279 | 🐛 2 | 📅 2026-09-09 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,626 | 🐛 3 | 📅 2026-08-10 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,538 | 🐛 0 | 📅 2026-09-01 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,324 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, and contests related to remote sensing change detection.
